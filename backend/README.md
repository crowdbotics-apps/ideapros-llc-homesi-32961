...
## Project Structure
    ...
    ├── ideapros_llc_homesi_32961  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_homesi_32961`
...
2. Clone this repo and `cd ideapros_llc_homesi_32961`
